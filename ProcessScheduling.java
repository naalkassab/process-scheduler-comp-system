...
public class ProcessScheduling {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner s = new Scanner(new File
                ("/Users/nabaaalkassab/Documents/CS526 Fall 2 2021/src/com/company/process_scheduling_in.txt"));
        ...
        while (s.hasNext()) {
            ...
            Process p1 = new Process(Integer.parseInt(lineContents[0]), Integer.parseInt(lineContents[1]),
        ...
        //print out max wait time
        writer.println();
        writer.println("Maximum wait time ="+max_wait);
        writer.println();
